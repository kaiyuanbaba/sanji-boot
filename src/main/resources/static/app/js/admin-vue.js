...
var data = {
        ...
        menus: [
            ...
            // },
            {
                ...
                icon: 'zmdi-accounts',
                children: [
                    { title: '人脸识别', icon: '', url: 'page/sys/photo/index.html', isOpenTab: true },
                    { title: '用户管理', icon: '', url: 'page/sys/user/table.html', isOpenTab: true },
                    { title: '学生月考勤列表', icon: '', url: 'page/sys/student/table.html', isOpenTab: true },
                    { title: '点名管理', icon: '', url: 'page/sys/rollCall/rollCall.html', isOpenTab: true },
                    { title: '学生月考勤统计图', icon: '', url: 'page/sys/studentForm/index.html', isOpenTab: true },
                    { title: '角色管理', icon: '', url: 'page/sys/role/table.html', isOpenTab: true }
                ]
            },
            {
                title: ' 监控管理',
                icon: 'zmdi zmdi-assignment',//zmdi-lock-outline
                children: [
                    // { title: '权限管理', icon: '', url: 'page/sys/menu/menus.html', isOpenTab: true },
                    { title: '操作日志', icon: 'zmdi zmdi-assignment', url: 'page/sys/log/table.html', isOpenTab: true },
                ]
            },
            // {
            //     title: '其他数据管理',
...
var util = {
    ...
    getSystemList: function(fc) {
        iGet('/api/users/current/menu', function(datas) {
            var datas = datas;
            datas && datas.forEach(function(obj) {
                obj.title = obj.name;
                obj.name = obj.skin;
            })
            fc(data);
